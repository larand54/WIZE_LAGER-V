...
//
//  PURPOSE        :  Contains some general-purpose functions for general
//                    use in the project. Use this unit to hold non-class
//                    code either for use in multiple units, or to remove
//                    clutter from other units.
//
//
//  NOTES          :
//
