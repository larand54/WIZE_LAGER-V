...
//  peMoveToLogInv.Items.Insert(0,'No Change');
 ...
 End ; //with
  ...
  grdPackages.LoadFromIniFile(dmsConnector.InifilesMap+'ExtMovePkg'+'.'+ThisUser.UserName);
end;
...
begin
 ...
 Begin
  ...
  End ;
  grdPackages.SaveToIniFile(dmsConnector.InifilesMap+'ExtMovePkg'+'.'+ThisUser.UserName);
  CloseDataSets;
 End ;
end;
