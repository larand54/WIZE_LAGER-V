...
uses
  ...
  dxPScxExtEditorProducers, dxPScxPageControlProducer, dxPScxPivotGrid2Lnk,
  dxPScxCheckListBoxLnk, dxPSLbxLnk, dxPSTextLnk, dxPSDBTCLnk, CRAXDRT_TLB;
...
type
  TfrmInventoryReport = class(TForm)
    ...
    acRefreshProductionByPackageNo: TAction;
    ...
    procedure acRefreshProductionByPackageNoExecute(Sender: TObject);
...
uses VidaType, dmsDataConn, VidaUser, dm_Inventory, dmsVidaContact, VidaConst,
  ...
  uVardaBortPkt, uchgPkgVard, uSokAvropMall, uEntryPriceField;
...
procedure TfrmInventoryReport.SetCheckComboBoxes_Where_PktNrLevKod_Required (const PktNrLevKod : String) ;
Begin
 With dmInventory do
 Begin
...
begin
 ...
 End ;
  ...
  sq_PkgList.SQL.Add('RTRIM(pn.SupplierCode) AS LEVKOD,') ;
  ...
  sq_PkgList.SQL.Add('pn.Original_Price AS Pris,') ;
  sq_PkgList.SQL.Add('pn.Original_Price * pt.Totalm3Nominal AS Värde, va.VarugruppNamn, LS.AvgLength, pn.REFERENCE, pn.BL_NO,  pn.Info2') ;
...
//  if (mtActLengthMM.RecordCount > 0) or (cbShowSingleLengthPkgs.Checked) then
  ...
  sq_PkgList.SQL.Add('Left Outer Join dbo.Varugrupp va on va.VarugruppNo = PD.VarugruppNo') ;
...
{  if mt_GradeStamp.RecordCount > 0 then
  ...
  sq_PkgList.SQL.Add('AND pn.DateCreated >= ' + QuotedStr(DateTimeToStr(deStartPeriod.Date))) ;

  if deEndPeriod.EditValue > 0 then
  sq_PkgList.SQL.Add('AND pn.DateCreated <= ' + QuotedStr(DateTimeToStr(deEndPeriod.Date))) ;


  if Length(TRIM(teREF.Text)) > 0 then
  Begin
   sq_PkgList.SQL.Add('AND pn.REFERENCE = ' + QuotedStr(TRIM(teREF.Text))) ;
  End ;
...
//  sq_PkgList.SQL.Add('AND Verk.ClientNo  = '+IntToStr(mtUserPropOwnerNo.AsInteger)) ;
  ...
  sq_PkgList.SQL.Add(GetSQLofComboFilter(0, 'va.VaruGruppNo', ccVarugrupp)) ;
  ...
  sq_PkgList.SQL.Add(GetSQLofComboFilter(1, 'pg.NominalThicknessMM', ccbNT)) ;
  sq_PkgList.SQL.Add(GetSQLofComboFilter(1, 'pg.NominalWidthMM', ccbNB)) ;
  ...
  sq_PkgList.SQL.Add('Gr.GradeName, SUR.SurfacingName, va.VarugruppNamn, LS.AvgLength, pn.REFERENCE, pn.BL_NO,  pn.Info2, ') ;

  sq_PkgList.SQL.Add('pn.Original_Price,') ;
...
{  if mt_GradeStamp.RecordCount > 0 then
  ...
  sq_PkgList.SQL.Add('pn.Original_Price, pn.REFERENCE, pn.BL_NO,  pn.Info2, ') ;

  sq_PkgList.SQL.Add('Gr.GradeName, SUR.SurfacingName, ') ;
  sq_PkgList.SQL.Add('Verk.ClientNo , Cy.CityName, lip.LogicalInventoryName,') ;
  sq_PkgList.SQL.Add('lip.LogicalInventoryPointNo, pip.PhysicalInventoryPointNo, va.VarugruppNamn, LS.AvgLength') ;
  if (mtUserPropNewItemRow.AsInteger > 0) and (cbInvLista.ItemIndex = 0) then
  sq_PkgList.SQL.Add(',isnull(avrPkg.Status,1)') ;
...
//  sq_InvSum.SQL.Add('Inner Join dbo.ProductLength pl ON pl.ProductLengthNo = ptd.ProductLengthNo') ;
  ...
  sq_InvSum.SQL.Add('Left Outer Join dbo.Varugrupp va on va.VarugruppNo = PD.VarugruppNo') ;
...
//  sq_InvSum.SQL.Add('AND Verk.ClientNo  = '+IntToStr(mtUserPropOwnerNo.AsInteger)) ;
  ...
  sq_InvSum.SQL.Add(GetSQLofComboFilter(0, 'va.VaruGruppNo', ccVarugrupp)) ;
  ...
  sq_InvSum.SQL.Add(GetSQLofComboFilter(1, 'pg.NominalThicknessMM', ccbNT)) ;
  sq_InvSum.SQL.Add(GetSQLofComboFilter(1, 'pg.NominalWidthMM', ccbNB)) ;
...
//  sq_InvSum.Close ;
  ...
  sq_PcsPerLen.SQL.Add('Left Outer Join dbo.Varugrupp va on va.VarugruppNo = PD2.VarugruppNo') ;
...
//  sq_PcsPerLen.SQL.Add('AND Verk2.ClientNo  = '+IntToStr(mtUserPropOwnerNo.AsInteger)) ;
  ...
  sq_PcsPerLen.SQL.Add('Left Outer Join dbo.Varugrupp va on va.VarugruppNo = PD.VarugruppNo') ;
...
//  sq_PcsPerLen.SQL.Add('AND Verk.ClientNo  = '+IntToStr(mtUserPropOwnerNo.AsInteger)) ;
  ...
  sq_PcsPerLen.SQL.Add(GetSQLofComboFilter(0, 'va.VaruGruppNo', ccVarugrupp)) ;
  ...
  sq_PcsPerLen.SQL.Add(GetSQLofComboFilter(1, 'pg.NominalThicknessMM', ccbNT)) ;
  sq_PcsPerLen.SQL.Add(GetSQLofComboFilter(1, 'pg.NominalWidthMM', ccbNB)) ;
...
//  cbVolUnitLengths.Enabled  := True ;
 ...
 if pcInventory.ActivePage = tsProduktionPerPaketnr then
 Begin
...
//LARS!!   cbVolUnitLengths.Enabled  := False ;
 ...
 if pcInventory.ActivePage = tsProduktionProduktSummary then
 Begin
  lcLengthGroup.Enabled     := False ;
//  ccMatpunkt.
//  cbLengthFormat.Enabled    := False ;
//LARS!!   cbVolUnitLengths.Enabled  := False ;
 ...
 if pcInventory.ActivePage = tsLevStat then
 Begin
  lcLengthGroup.Enabled     := False ;
//  cbLengthFormat.Enabled    := False ;
//LARS!!   cbVolUnitLengths.Enabled  := False ;
...
{  sq_PkgList.SQL.Add('CASE WHEN PTL.STD_Length = 0 THEN') ;
  ...
  sq_PkgList.SQL.Add('SUM(pn.Original_Price * ptd.m3Nominal) / SUM(ptd.m3Nominal) AS Pris,') ;
  sq_PkgList.SQL.Add('SUM(pn.Original_Price * ptd.m3Nominal) AS Värde, va.VarugruppNamn, (SUM(ptd.LinealMeterActualLength) / SUM(ptd.NoOfPieces)) AS AvgLength, ' + QuotedStr('') + ' AS REFERENCE, ' + QuotedStr('') + ' AS BL_NO, ' + QuotedStr('') + ' AS Info2') ;
...
//  sq_PkgList.SQL.Add('AND Verk.ClientNo  = '+IntToStr(mtUserPropOwnerNo.AsInteger)) ;
  ...
  sq_PkgList.SQL.Add('Cy.CityName, lip.LogicalInventoryName, lip.LogicalInventoryPointNo, pip.PhysicalInventoryPointNo, va.VarugruppNamn') ;
  if (mtUserPropNewItemRow.AsInteger > 0) and (cbInvLista.ItemIndex = 0) then
   sq_PkgList.SQL.Add(',isnull(avrPkg.Status,1)') ;
...
{  sq_PkgList.SQL.Add('CASE WHEN PTL.STD_Length = 0 THEN') ;
  ...
  sq_PkgList.SQL.Add('SUM(pn.Original_Price * pt.Totalm3Nominal) / SUM(pt.Totalm3Nominal) AS Pris,') ;
  sq_PkgList.SQL.Add('SUM(pn.Original_Price * pt.Totalm3Nominal) AS Värde, va.VarugruppNamn, (SUM(ptd.LinealMeterActualLength) / SUM(ptd.NoOfPieces)) AS AvgLength, pn.REFERENCE, pn.BL_NO,  pn.Info2') ;

  sq_PkgList.SQL.Add('FROM  dbo.Client Verk') ;
  sq_PkgList.SQL.Add('Inner Join dbo.Loads L on L.SupplierNo = Verk.ClientNo') ;
  sq_PkgList.SQL.Add('Inner Join dbo.LoadDetail LD on LD.LoadNo = L.LoadNo') ;
  sq_PkgList.SQL.Add('Inner Join dbo.CustomerShippingPlanDetails csd on csd.CustShipPlanDetailObjectNo = LD.DefaultCustShipObjectNo') ;
  sq_PkgList.SQL.Add('Inner Join dbo.CustomerShippingPlanHeader csh on csh.ShippingPlanNo = csd.ShippingPlanNo') ;
  sq_PkgList.SQL.Add('Inner Join dbo.Orders oh on oh.OrderNo = csh.OrderNo') ;
  sq_PkgList.SQL.Add('Inner Join dbo.LogicalInventoryPoint lip ON lip.LogicalInventoryPointNo = LD.LIPNo') ;
  sq_PkgList.SQL.Add('Inner Join dbo.PhysicalInventoryPoint pip ON pip.PhysicalInventoryPointNo = lip.PhysicalInventoryPointNo') ;
  sq_PkgList.SQL.Add('INNER JOIN dbo.PackageNumber pn ON pn.PackageNo = LD.PackageNo and pn.SupplierCode = LD.SupplierCode') ;
...
//  if thisuser.UserID = 8 then sq_PkgList.SQL.SaveToFile('sq_PkgSumListNOTInvoiced.txt');
 End ; //with
...
begin
 ...
 Begin
  ...
  sq_PkgNoList.SQL.Add('va.VarugruppNamn, LS.AvgLength, pn.REFERENCE, pn.BL_NO,  pn.Info2') ;
...
//  if (mtActLengthMM.RecordCount > 0) or (cbShowSingleLengthPkgs.Checked) then
  ...
  sq_PkgNoList.SQL.Add('Left Outer Join dbo.Varugrupp va on va.VarugruppNo = PD.VarugruppNo') ;
  ...
  if deStartPeriod.EditValue > 0 then
  sq_PkgNoList.SQL.Add('AND pn.DateCreated >= ' + QuotedStr(DateTimeToStr(deStartPeriod.Date))) ;

  if deEndPeriod.EditValue > 0 then
  sq_PkgNoList.SQL.Add('AND pn.DateCreated <= ' + QuotedStr(DateTimeToStr(deEndPeriod.Date))) ;


  if Length(TRIM(teREF.Text)) > 0 then
  Begin
   sq_PkgNoList.SQL.Add('AND pn.REFERENCE = ' + QuotedStr(TRIM(teREF.Text))) ;
  End ;
...
//  sq_PkgNoList.SQL.Add('AND Verk.ClientNo  = '+IntToStr(mtUserPropOwnerNo.AsInteger)) ;
  ...
  sq_PkgNoList.SQL.Add('Gr.GradeName, SUR.SurfacingName, Verk.ClientNo, Cy.CityName, lip.LogicalInventoryName, lip.LogicalInventoryPointNo, pip.PhysicalInventoryPointNo, pn.REFERENCE, pn.BL_NO,  pn.Info2') ;
  if (mtUserPropNewItemRow.AsInteger > 0) and (cbInvLista.ItemIndex = 0) then
  sq_PkgNoList.SQL.Add(',isnull(avrPkg.Status,1)')
  else
  sq_PkgNoList.SQL.Add(',pn.Status') ;

  sq_PkgNoList.SQL.Add(', va.VarugruppNamn, LS.AvgLength') ;



//  if thisuser.UserID = 8 then
// sq_PkgNoList.SQL.SaveToFile('sq_PkgNoSUBList.txt');
...
//  else
  ...
  sq_PkgList.SQL.Add('SUM(pn.Original_Price * pt.Totalm3Nominal) / SUM(pt.Totalm3Nominal) AS Pris,') ;
  sq_PkgList.SQL.Add('SUM(pn.Original_Price * pt.Totalm3Nominal) AS Värde, va.VarugruppNamn, LS.AvgLength, pn.REFERENCE, pn.BL_NO,  pn.Info2') ;
...
//  sq_PkgList.SQL.Add('AND Verk.ClientNo  = '+IntToStr(mtUserPropOwnerNo.AsInteger)) ;
  ...
  sq_PkgList.SQL.Add('Group By pd.ProductNo, pd.ProductDisplayName, pg.ActualThicknessMM, pg.ActualWidthMM,') ;
  sq_PkgList.SQL.Add('SPE.SpeciesName, Gr.GradeName, SUR.SurfacingName, imp.ProductCategoryName, Verk.ClientNo, ') ;
  sq_PkgList.SQL.Add('Cy.CityName, lip.LogicalInventoryName, lip.LogicalInventoryPointNo, pip.PhysicalInventoryPointNo, pn.REFERENCE, pn.BL_NO,  pn.Info2') ;
//  if (mtUserPropNewItemRow.AsInteger > 0) and (cbInvLista.ItemIndex = 0) then
//   sq_PkgList.SQL.Add(',isnull(avrPkg.Status,1)') ;
...
begin
 ...
 Begin
  ...
  sq_PLIP.SQL.Add('Inner Join dbo.UserArrivalPoint uap ON uap.PhyInvPointNameNo = PH.PhyInvPointNameNo') ;
  ...
  sq_PLIP.SQL.Add('AND PH.OwnerNo = ' + IntToStr(ThisUser.CompanyNo)) ;
  sq_PLIP.SQL.Add('AND uap.UserID = ' + IntToStr(ThisUser.UserID)) ;
...
{  sq_PkgList.SQL.Add('CASE') ;
  ...
  sq_PkgList.SQL.Add('1.0 AS Pris,') ;
  sq_PkgList.SQL.Add('1.0 AS Värde,') ;
  sq_PkgList.SQL.Add(QuotedStr('N/A') + ' AS VarugruppNamn, 0.0 AS AvgLength, pn.REFERENCE, pn.BL_NO,  pn.Info2') ;
...
//  sq_PkgList.SQL.Add('SPE.SpeciesName, Gr.GradeName, SUR.SurfacingName, imp.ProductCategoryName, pn.REFERENCE, pn.BL_NO,') ;
...
//  sq_PkgList.SQL.Add('0 AS OwnerNo, ' + 'Cast(0 AS Varchar(101)) AS Lager,') ;
  ...
  sq_PkgList.SQL.Add('Gr.GradeName, SUR.SurfacingName, ') ;
  sq_PkgList.SQL.Add('IH.InvoiceType, IH.InternalInvoiceNo, IL.SHIPPINGPLANNO, pn.REFERENCE, pn.BL_NO,  pn.Info2') ;
...
//  sq_PkgList.SQL.Add('SUR.SurfacingName AS UT,') ;
  ...
  sq_PkgList.SQL.Add('1.0 AS Pris,') ;
  sq_PkgList.SQL.Add('1.0 AS Värde,') ;
  sq_PkgList.SQL.Add(QuotedStr('N/A') + ' AS VarugruppNamn, 0.0 AS AvgLength, ' + QuotedStr('') + ' AS REFERENCE, ' + QuotedStr('') + ' AS BL_NO, ' + QuotedStr('') + ' AS Info2') ;
...
procedure TfrmInventoryReport.cxButton1Click(Sender: TObject);
begin
 Close ;
end;

procedure TfrmInventoryReport.cxButton2Click(Sender: TObject);
begin
 ClearProductFilter ;
end;
...
procedure TfrmInventoryReport.acRefreshProductionByPackageNoExecute(
  Sender: TObject);
begin
 with dmInventory do
 Begin
...
procedure TfrmInventoryReport.Build_ProductionByPackageNo ;
Begin
{ With sq_ProductionByPackageNo.
Select distinct
CASE
WHEN pp.Operation = 0 THEN 'PÅREGISTRERAT'
WHEN pp.Operation = 3 THEN 'AVREGISTRERAT'
END AS Operation,
pd.ProductNo,
...
CAST(pp.ProductionDate AS DATE) AS TILLVERKAD,
SPE.SpeciesName AS TS,
imp.ProductCategoryName AS PC,
Gr.GradeName AS KV,
SUR.SurfacingName AS UT,
pp.SupplierNo AS OwnerNo,
LS.AvgLength, st.ShiftTeamName, rp.RegPointName,
ISNULL(RTRIM(rp.RegPointName),'') + '/' + ISNULL(st.ShiftTeamName,'NA') AS MP_SkiftLag
...
AND pp.ProductionDate >= '2011-12-01'
AND pp.ProductionDate <= '2011-12-11'
}
End ;
