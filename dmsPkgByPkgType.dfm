object dm_PkgByPkgType: Tdm_PkgByPkgType
  ...
  object sq_PkgCodes: TSQLQuery
    ...
    SQL.Strings = (
      ...
      'PackageType pt'
        ...
        'INNER JOIN PackageTypeDetail ptd ON ptd.PackageTypeNo = pt.Packa' +
        'geTypeNo'
      'INNER JOIN Product pd ON pd.ProductNo = pt.ProductNo'
        ...
        'LEFT OUTER JOIN ProductCategory pc ON pc.ProductCategoryNo = pg.' +
        'ProductCategoryNo'
      'LEFT OUTER JOIN GradeStamp gs ON gs.GradeStampNo = pt.GradeStamp'
      'LEFT OUTER JOIN BarCode bc ON bc.BarCodeNo = pt.BarCodeID'
      ''
      ...
      ''
        ...
        'INNER JOIN ProductLength pl ON pl.ProductLengthNo = ptd.ProductL' +
        'engthNo'
      
        'INNER JOIN PackageCode pcd ON pcd.PackageTypeNo = pt.PackageType' +
        'No'
      ''
      'WHERE'
  ...
  object cds_PkgCodes: TClientDataSet
    ...
    object cds_PkgCodesPET_LE: TIntegerField
      FieldName = 'PET_LE'
    end
    object cds_PkgCodesFJ_LE: TIntegerField
      FieldName = 'FJ_LE'
    end
  ...
  object sq_PC: TSQLQuery
    ...
    SQL.Strings = (
      ...
      ' PackageCode pcd'
        ...
        ' INNER JOIN PackageType pt ON pt.PackageTypeNo = pcd.PackageType' +
        'No'
      ' INNER JOIN Product pd ON pd.ProductNo = pt.ProductNo'
      
        ' INNER JOIN ProductGroup pg ON pg.ProductGroupNo = pd.ProductGro' +
        'upNo'
      
        ' LEFT OUTER JOIN GradeStamp gs ON gs.GradeStampNo = pt.GradeStam' +
        'p'
      ' LEFT OUTER JOIN BarCode bc ON bc.BarCodeNo = pt.BarCodeID'
      ''
      ' INNER JOIN      dbo.Grade gd ON pd.GradeNo = gd.GradeNo'
