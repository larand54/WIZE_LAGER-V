...
uses
  SysUtils, Classes,
  VidaType, SqlTimSt,  Dialogs, kbmMemTable, Variants, uADStanIntf,
  uADStanOption, uADStanParam, uADStanError, uADDatSManager, uADPhysIntf,
  uADDAptIntf, uADStanAsync, uADDAptManager, uADCompClient, uADCompDataSet, DB;
...
type
  TdmsContact = class(TDataModule)
    ...
    sq_InsCliEtik: TADQuery;
    sq_GetSRNo: TADQuery;
    sq_GetSRNoSalesRegionNo: TIntegerField;
    sq_DelCliEtik: TADQuery;
    ...
    sq_GetCityNoFromPIP: TADQuery;
    sq_GetCityNoFromPIPPhyInvPointNameNo: TIntegerField;
    sq_GetSalesRegionNo: TADQuery;
    ...
    sq_DelClient: TADQuery;
    sq_IsClientMarkedAsIntVerk: TADQuery;
    ...
    procedure cds_PhysInvAfterApplyUpdates(DataSet: TADDataSet; AErrors: Integer);
...
procedure TdmsContact.cds_PhysInvAfterApplyUpdates(DataSet: TADDataSet;
  AErrors: Integer);
begin
...
//    SQL.Add('SELECT ClientNo, ClientName, ClientCode FROM Client WHERE ');
    ...
    SQL.Add('ADR.AddressLine1 AS Addressrad1, ADR.PostalCode AS PostNr,');
    SQL.Add('C.VATNO AS VatNr, Cy.CityName AS Stad');
    SQL.Add('FROM dbo.Client C');
    SQL.Add('Left Outer Join dbo.CompanyAddress CA');
    SQL.Add('Inner Join dbo.Address ADR ON ADR.AddressNo = CA.AddressNo');
    SQL.Add('Inner Join dbo.City Cy on Cy.CityNo = ADR.CityNo');
