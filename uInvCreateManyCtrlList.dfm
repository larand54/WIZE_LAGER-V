object fInvCreateManyCtrlList: TfInvCreateManyCtrlList
  ...
  object adm_SelectedRows: TkbmMemTable
    DesignActivation = True
    AttachedAutoRefresh = True
    AttachMaxCount = 1
    FieldDefs = <>
    ...
    Left = 144
    Top = 462
    object adm_SelectedRowsInventeringsNr: TIntegerField
      FieldName = 'InventeringsNr'
    end
    object adm_SelectedRowsLIPNo: TIntegerField
      FieldName = 'LIPNo'
    end
    object adm_SelectedRowsStatus: TIntegerField
      FieldName = 'Status'
    end
  end
end
