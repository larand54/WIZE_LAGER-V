...
type
  Tdm_PkgByPkgType = class(TDataModule)
    ...
    cds_PkgCodesPET_LE: TIntegerField;
    cds_PkgCodesFJ_LE: TIntegerField;
  ...
  public
    ...
    function  SavePackages2(const OwnerNo, ProducerNo, RegistrationPointNo, LogicalInventoryPointNo: Integer) : Boolean ;
...
function Tdm_PkgByPkgType.SavePackages2(const OwnerNo, ProducerNo, RegistrationPointNo, LogicalInventoryPointNo: Integer) : Boolean ;
Var
    Save_Cursor:TCursor;
    OldIndexName : String ;
var
...
//  PackagetypeNo  : Integer ;
  ...
  begin
    ...
    sp_NewPackageNo.ParamByName('DateCreated'            ).AsSQLTimeStamp := DateTimeToSQLTimeStamp(Date) ;
