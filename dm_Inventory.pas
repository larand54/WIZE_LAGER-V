...
uses
  ...
  uADDAptManager, SQLtimst, Vcl.Menus, dxmdaset ;
...
type
  TdmInventory = class(TDataModule)
    ...
    sq_Temp_Inventory: TADQuery;
    sq_LogInvByOwnerCity: TADQuery;
    ...
    sq_GetHighPcsNoLength: TADQuery;
    ...
    sq_Kund: TADQuery;
    sq_Land: TADQuery;
    sq_Matpunkt: TADQuery;
    sq_SkiftLag: TADQuery;
    sq_NT: TADQuery;
    sq_NB: TADQuery;
    ds_ProductionByPackageNo: TDataSource;
    ds_ProductionByProduct: TDataSource;
    ds_DeliveryStat: TDataSource;
    cds_ProductionByPackageNo: TADQuery;
    cds_ProductionByProduct: TADQuery;
    cds_DeliveryStat: TADQuery;
    ...
    sp_Manuell_LipSum: TADStoredProc;
