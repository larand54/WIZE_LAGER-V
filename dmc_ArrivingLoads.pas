...
type
 ...
 TAmbiguityEvent = procedure(
  ...
  TdmArrivingLoads = class(TDataModule)
    ...
    cdsArrivingLoadsLASTSTÄLLE: TStringField;
    ...
    cdsCurrentLoadDetails: TADQuery;
    ...
    cdsPortArrivingLoadsLASTSTÄLLE: TStringField;
    cdsPortArrivingLoadsLipNo: TIntegerField;
    cdsPortArrivingLoadsMÄRKNING: TStringField;
    cds_PIP: TADQuery;
    ...
    sp_ArrivingLoads: TADStoredProc;
    ...
    sp_vis_SetDateCreatedPkgsVP: TADStoredProc;
    sq_samLast: TADQuery;
    ...
    sq_SearchPkgNoMÄRKNING: TStringField;
    ...
    cdsPortArrivingPackagesMÄRKNING: TStringField;
    ...
    sq_SearchLoadNoByPkgNoMÄRKNING: TStringField;
...
begin
 ...
 cdsPortArrivingPackages.ParamByName('Reference').AsString        := cdsPortArrivingLoadsMÄRKNING.AsString ;
