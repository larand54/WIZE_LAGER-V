...
type
  ...
  TProdInstruRec = Record     // Used for filling in package panel in
    GradeStamp  : Integer;    // Load Entry form.
    BarCode     : Integer;
    PaperWrap   : Integer;
    MiniTies    : Boolean;
    ShrinkWrap  : Boolean;
  ...
  TPlanObj = record
    ...
    ShipPlanObjectNo  : Integer;
    ProductNo         : Integer;
    ActualThicknessMM : Double;
    ActualWidthMM     : Double;
    end;
