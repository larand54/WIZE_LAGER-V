object frmGetProduct: TfrmGetProduct
  Left = 213
  Top = 136
  Width = 1067
  Height = 673
  ...
  object Panel1: TPanel
    ...
    object lcGrade: TcxDBLookupComboBox
      ...
      Properties.ListSource = dmProduct.ds_grade
    ...
    object lcSpecies: TcxDBLookupComboBox
      ...
      Properties.ListOptions.AnsiSort = True
      Properties.ListOptions.ShowHeader = False
      Properties.ListSource = dmProduct.ds_Species
      Properties.MaxLength = 0
      Style.ButtonTransparency = ebtHideInactive
      TabOrder = 5
      Width = 138
    ...
    object lcSurfacing: TcxDBLookupComboBox
      ...
      Properties.ListOptions.AnsiSort = True
      Properties.ListOptions.ShowHeader = False
      Properties.ListSource = dmProduct.ds_Surfacing
      Properties.MaxLength = 0
      Style.ButtonTransparency = ebtHideInactive
      TabOrder = 4
      Width = 217
    ...
    object lcImpreg: TcxDBLookupComboBox
      ...
      Properties.ListOptions.AnsiSort = True
      Properties.ListOptions.ShowHeader = False
      Properties.ListSource = dmProduct.ds_ProdCatg
      Properties.MaxLength = 0
      Style.ButtonTransparency = ebtHideInactive
      TabOrder = 6
      Width = 141
    ...
    object cbLengthSpec: TcxDBComboBox
      ...
      DataBinding.DataSource = dsLager
    ...
    object tsProduktLista: TcxTabSheet
      ...
      object grdProdList: TcxGrid
        ...
        object grdProdListDBTableView1: TcxGridDBTableView
          ...
          DataController.DataSource = dmProduct.ds_ProdList
      ...
      object Panel3: TPanel
        ...
        object grdClientProd: TcxGrid
          ...
          object grdClientProdDBTableView1: TcxGridDBTableView
            OnDblClick = grdClientProdDBTableView1DblClick
            NavigatorButtons.ConfirmDelete = False
    ...
    object tsAnpassadLista: TcxTabSheet
      ...
      object grdCustDimProd: TcxGrid
        ...
        object grdCustDimProdDBTableView1: TcxGridDBTableView
          OnDblClick = grdCustDimProdDBTableView1DblClick
          NavigatorButtons.ConfirmDelete = False
  ...
  object PanelSelectedProducts: TPanel
    ...
    object grdSelectedProducts: TcxGrid
      ...
      object grdSelectedProductsDBTableView1: TcxGridDBTableView
        ...
        object grdSelectedProductsDBTableView1LengthDesc: TcxGridDBColumn
  ...
  object mtLager: TkbmMemTable
    ...
    Left = 368
    Top = 184
    object mtLagerProductLengthNo: TIntegerField
      FieldName = 'ProductLengthNo'
    end
    object mtLagerLengthSpec: TStringField
      FieldName = 'LengthSpec'
      OnChange = mtLagerLengthSpecChange
      Size = 15
    end
    object mtLagerALMM: TFloatField
      FieldName = 'ALMM'
    end
  end
  object dsLager: TDataSource
    DataSet = mtLager
    Left = 368
    Top = 216
  end
  object dsMarkedProd: TDataSource
    DataSet = dmProduct.mtMarkedProd
    Left = 281
    Top = 174
  end
