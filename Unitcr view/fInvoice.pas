...
uses
  ...
  cxControls, CRAXDRT_TLB, cxContainer, cxEdit, cxTextEdit, cxMemo,
  cxRichEdit, cxDBRichEdit ;

type
  TfrmInvoice = class(TfrmDBForm)
    ...
    ToolbtnGetInvoiceNo: TToolButton;
    ...
    procedure acKlientInvoiceExecute(Sender: TObject);
...
//Calculate VAT if Country is SWEDEN and cbVAT (Skatteupplag) checked
 if Trim(cdsInvoiceHeadCountryName.AsString) = 'SVERIGE' then
...
Begin
 ...
 Begin
  ...
  Begin
   ...
   ToolbtnGetInvoiceNo.Enabled:= False ;
//   ToolbtnSave.Enabled:= False ;
   ToolbtnAddTab.Enabled:= False ;
...
//   tsNotes.Enabled:= False ;
  ...
  ToolbtnPrintSPEC.Enabled:= True ;
  toolbtn_DBForm_2.Enabled:= True ;
...
procedure TfrmInvoice.ToolButton5Click(Sender: TObject);
begin
  inherited;
 Summarize(Sender) ;
end;

procedure TfrmInvoice.Label10DblClick(Sender: TObject);
begin
  inherited;
 with dmVidaInvoice, dmModule1 do
 Begin
  FormAddress := TFormAddress.Create(Self);
  Try
...
begin
 ...
 with dmVidaInvoice, dmModule1 do
 Begin
   FormSelectClient:= TFormSelectClient.Create(Self);
   Try
...
procedure TfrmInvoice.LCustomerDblClick(Sender: TObject);
begin
  inherited;
 with dmVidaInvoice, dmModule1 do
 Begin
  ...
  Begin
   ...
   Try
    ...
    Begin
     ...
     cdsInvoiceHeadInvoiceText.AsVariant:=  GetInvoiceTextByClient (cdsInvoiceHeadCustomerNo.AsInteger) ;// sq_ClientDataInvoiceText.AsVariant ;
...
procedure TfrmInvoice.Label36DblClick(Sender: TObject);
begin
  inherited;
 with dmVidaInvoice, dmModule1 do
 Begin
...
procedure TfrmInvoice.Label6DblClick(Sender: TObject);
begin
  inherited;
 ...
 FormDelTerms:= TFormDelTerms.Create(Self);
 Try
...
procedure TfrmInvoice.LPaymentTermsDblClick(Sender: TObject);
begin
  inherited;
 ...
 FormPaymentTerms:= TFormPaymentTerms.Create(Self);
 Try
...
begin
 ...
 Begin
  FormCarrier:= TFormCarrier.Create(Self);
  Try
...
begin
 ...
 (dmVidaInvoice.cdsInvoiceDetail.ChangeCount > 0) or
  (dmVidaInvoice.cdsInvoiceShipTo.ChangeCount > 0)  then
    Begin
     ShowMessage('Du måste spara fakturan först.') ;
     Exit ;
    End ;
...
{ if (dmVidaInvoice.cdsInvoiceHead.ChangeCount > 0) or
 ...
 (dmVidaInvoice.cdsInvoiceDetail.ChangeCount > 0) or
  (dmVidaInvoice.cdsInvoiceShipTo.ChangeCount > 0)  then
    Begin
     ShowMessage('You must save the invoice first') ;
     Exit ;
    End ; }
 ...
 FormCRViewReport.CreateCo(Self,'FAKTURA_ENG_NOTE.RPT',AppName) ;
...
{ if (dmVidaInvoice.cdsInvoiceHead.ChangeCount > 0) or
 ...
 FormCRViewReport.CreateCo(Self,'FAKTURA_ENG_längd_NOTE.RPT',AppName) ;
 if FormCRViewReport.ReportFound then
 Begin
  FormCRViewReport.report.ParameterFields.Item[1].AddCurrentValue(dmVidaInvoice.cdsInvoiceHeadInternalInvoiceNo.AsInteger);
  FormCRViewReport.CRViewer91.ReportSource:= FormCRViewReport.Report ;
...
{ if (dmVidaInvoice.cdsInvoiceHead.ChangeCount > 0) or
 ...
 FormCRViewReport.CreateCo(Self,'FAKTURA_ENG_KP_NOTE.RPT',AppName) ;
 if FormCRViewReport.ReportFound then
 Begin
  FormCRViewReport.report.ParameterFields.Item[1].AddCurrentValue(dmVidaInvoice.cdsInvoiceHeadInternalInvoiceNo.AsInteger);
  FormCRViewReport.CRViewer91.ReportSource:= FormCRViewReport.Report ;
...
{ if (dmVidaInvoice.cdsInvoiceHead.ChangeCount > 0) or
 ...
 FormCRViewReport.CreateCo(Self,'FAKTURA_u_moms_NOTE.RPT',AppName) ;
 if FormCRViewReport.ReportFound then
 Begin
  FormCRViewReport.report.ParameterFields.Item[1].AddCurrentValue(dmVidaInvoice.cdsInvoiceHeadInternalInvoiceNo.AsInteger);
  FormCRViewReport.CRViewer91.ReportSource:= FormCRViewReport.Report ;
...
begin
 ...
 FormCRViewReport.CreateCo(Self,'TRP_BREV.RPT',AppName) ;
 if FormCRViewReport.ReportFound then
 Begin
  FormCRViewReport.report.ParameterFields.Item[1].AddCurrentValue(dmVidaInvoice.cdsInvoiceHeadInternalInvoiceNo.AsInteger);
  FormCRViewReport.CRViewer91.ReportSource:= FormCRViewReport.Report ;
...
begin
 ...
 FormCRViewReport.CreateCo(Self,'SPECIFICATION_SV_VER2.RPT',AppName) ;
 if FormCRViewReport.ReportFound then
 Begin
  FormCRViewReport.report.ParameterFields.Item[1].AddCurrentValue(dmVidaInvoice.cdsInvoiceHeadInternalInvoiceNo.AsInteger);
  FormCRViewReport.CRViewer91.ReportSource:= FormCRViewReport.Report ;
...
begin
 ...
 FormCRViewReport.CreateCo(Self,'SPECIFICATION_VER2.RPT',AppName) ;
 if FormCRViewReport.ReportFound then
 Begin
  FormCRViewReport.report.ParameterFields.Item[1].AddCurrentValue(dmVidaInvoice.cdsInvoiceHeadInternalInvoiceNo.AsInteger);
  FormCRViewReport.CRViewer91.ReportSource:= FormCRViewReport.Report ;
...
if dmVidaInvoice.cdsInvoiceHeadInternalInvoiceNo.AsInteger < 1 then exit ;
 ...
 FormCRViewReport.CreateCo(Self,'SPECIFICATION_PROD_VER2.RPT',AppName) ;
 if FormCRViewReport.ReportFound then
 Begin
  FormCRViewReport.report.ParameterFields.Item[1].AddCurrentValue(dmVidaInvoice.cdsInvoiceHeadInternalInvoiceNo.AsInteger);
  FormCRViewReport.CRViewer91.ReportSource:= FormCRViewReport.Report ;
...
if dmVidaInvoice.cdsInvoiceHeadInternalInvoiceNo.AsInteger < 1 then exit ;
 ...
 FormCRViewReport.CreateCo(Self,'SPEC_ACT_VER2.RPT',AppName) ;
 if FormCRViewReport.ReportFound then
 Begin
  FormCRViewReport.report.ParameterFields.Item[1].AddCurrentValue(dmVidaInvoice.cdsInvoiceHeadInternalInvoiceNo.AsInteger);
  FormCRViewReport.CRViewer91.ReportSource:= FormCRViewReport.Report ;
...
if dmVidaInvoice.cdsInvoiceHeadInternalInvoiceNo.AsInteger < 1 then exit ;
 ...
 FormCRViewReport.CreateCo(Self,'SPEC_NOPKGNO.RPT',AppName) ;
 if FormCRViewReport.ReportFound then
 Begin
  FormCRViewReport.report.ParameterFields.Item[1].AddCurrentValue(dmVidaInvoice.cdsInvoiceHeadInternalInvoiceNo.AsInteger);
  FormCRViewReport.CRViewer91.ReportSource:= FormCRViewReport.Report ;
...
if dmVidaInvoice.cdsInvoiceHeadInternalInvoiceNo.AsInteger < 1 then exit ;
 ...
 FormCRViewReport.CreateCo(Self,'SPECIFICATION_IDAHO_VER2.RPT',AppName) ;
 if FormCRViewReport.ReportFound then
 Begin
  FormCRViewReport.report.ParameterFields.Item[1].AddCurrentValue(dmVidaInvoice.cdsInvoiceHeadInternalInvoiceNo.AsInteger);
  FormCRViewReport.CRViewer91.ReportSource:= FormCRViewReport.Report ;
...
if dmVidaInvoice.cdsInvoiceHeadInternalInvoiceNo.AsInteger < 1 then exit ;
 ...
 FormCRViewReport.CreateCo(Self,'FAKTURA_ENG_IDAHO_NOTE.RPT',AppName) ;
 if FormCRViewReport.ReportFound then
 Begin
  FormCRViewReport.report.ParameterFields.Item[1].AddCurrentValue(dmVidaInvoice.cdsInvoiceHeadInternalInvoiceNo.AsInteger);
  FormCRViewReport.CRViewer91.ReportSource:= FormCRViewReport.Report ;
...
if dmVidaInvoice.cdsInvoiceHeadInternalInvoiceNo.AsInteger < 1 then exit ;
 ...
 FormCRViewReport.CreateCo(Self,'FAKTURA_ENG_längd_plus_NM3_NOTE.RPT',AppName) ;
 if FormCRViewReport.ReportFound then
 Begin
  FormCRViewReport.report.ParameterFields.Item[1].AddCurrentValue(dmVidaInvoice.cdsInvoiceHeadInternalInvoiceNo.AsInteger);
  FormCRViewReport.CRViewer91.ReportSource:= FormCRViewReport.Report ;
...
begin
 ...
 FormCRViewReport.CreateCo(Self,'FAKTURA_ENG_PKTTYP_NOTE.RPT',AppName) ;
 if FormCRViewReport.ReportFound then
 Begin
  FormCRViewReport.report.ParameterFields.Item[1].AddCurrentValue(dmVidaInvoice.cdsInvoiceHeadInternalInvoiceNo.AsInteger);
  FormCRViewReport.CRViewer91.ReportSource:= FormCRViewReport.Report ;
...
procedure TfrmInvoice.acKlientInvoiceExecute(Sender: TObject);
Var param1, param2, param3 : Integer ;
begin
  inherited;
 if dmVidaInvoice.cdsInvoiceHeadInternalInvoiceNo.AsInteger < 1 then exit ;
 FormCRPrintReport:= TFormCRPrintReport.Create(Self);
 FormCRPrintReport.AppName:= AppName ;
 Try
  param1:= dmVidaInvoice.cdsInvoiceHeadInternalInvoiceNo.AsInteger ;
  param2:= 0 ;
  param3:= 0 ;

  FormCRPrintReport.CreateCo(Self,
                dmVidaInvoice.cdsInvoiceHeadCustomerNo.AsInteger, cFaktura,
                param1, param2, param3) ;
 Finally
  FormCRPrintReport.Free ;
 End ;

end;


procedure TfrmInvoice.acClientPkgSpecExecute(Sender: TObject);
Var param1, param2, param3 : Integer ;
begin
  inherited;
 if dmVidaInvoice.cdsInvoiceHeadInternalInvoiceNo.AsInteger < 1 then exit ;
 ...
 Try
  ...
  FormCRPrintReport.CreateCo(Self,
                dmVidaInvoice.cdsInvoiceHeadCustomerNo.AsInteger, cPkgSpec,
                param1, param2, param3) ;
 Finally
  FormCRPrintReport.Free ;
 End ;
...
begin
 ...
 FormCRViewReport.CreateCo(Self,'FAKTURA_u_moms_NOTE_dk.RPT',AppName) ;
 if FormCRViewReport.ReportFound then
 Begin
  FormCRViewReport.report.ParameterFields.Item[1].AddCurrentValue(dmVidaInvoice.cdsInvoiceHeadInternalInvoiceNo.AsInteger);
  FormCRViewReport.CRViewer91.ReportSource:= FormCRViewReport.Report ;
...
begin
 ...
 FormCRViewReport.CreateCo(Self,'FAKTURA_ENG_NOTE_dk.RPT', AppName) ;
 if FormCRViewReport.ReportFound then
 Begin
  FormCRViewReport.report.ParameterFields.Item[1].AddCurrentValue(dmVidaInvoice.cdsInvoiceHeadInternalInvoiceNo.AsInteger);
  FormCRViewReport.CRViewer91.ReportSource:= FormCRViewReport.Report ;
...
begin
 ...
 FormCRViewReport.CreateCo(Self,'SPECIFICATION_SV_VER2_dk.RPT', AppName) ;
...
begin
 ...
 FormCRViewReport.CreateCo(Self,'SPECIFICATION_VER2_dk.RPT', AppName) ;
 if FormCRViewReport.ReportFound then
 Begin
  FormCRViewReport.report.ParameterFields.Item[1].AddCurrentValue(dmVidaInvoice.cdsInvoiceHeadInternalInvoiceNo.AsInteger);
  FormCRViewReport.CRViewer91.ReportSource:= FormCRViewReport.Report ;
...
begin
  inherited;
  with TFormBookingForm.CreateCo(Self,
  StrToInt(TabControl1.Tabs[TabControl1.TabIndex]){LO Number}) do
  try

  if ToolbtnGetInvoiceNo.Enabled then
   ReadMeOnly:= False
    else
     ReadMeOnly:= True ;

    ShowModal ;
    if ReadMeOnly = False then
    Begin
     GetBookingData(Sender, StrToInt(TabControl1.Tabs[TabControl1.TabIndex])) ;
...
{ if (dmVidaInvoice.cdsInvoiceHead.ChangeCount > 0) or
 ...
 FormCRViewReport.CreateCo(Self,'FAKTURA_NOTE.RPT',AppName) ;
