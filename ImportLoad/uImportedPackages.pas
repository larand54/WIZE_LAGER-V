...
begin
 ...
 Begin
  ...
  Try
   ...
   sq_ImpClientMap.ParamByName('DeliveryMessageNumber').AsString  := DeliveryMessageNumber ;
   cds_ImpClientMap.Active:= True ;

   cds_DSDMR2.Active:= False ;
   sq_DSDMR2.ParamByName('DeliveryMessageNumber').AsString        := DeliveryMessageNumber ;
   cds_DSDMR2.Active:= True ;

   cds_ImpProdMap.Active:= False ;
   sq_ImpProdMap.ParamByName('DeliveryMessageNumber').AsString    := DeliveryMessageNumber ;
   sq_ImpProdMap.ParamByName('SalesRegionNo').AsInteger           := mtUserPropOwnerNo.AsInteger ;
   cds_ImpProdMap.Active:= True ;

   cds_ImpLenMap.Active:= False ;
   sq_ImpLenMap.ParamByName('DeliveryMessageNumber').AsString     := DeliveryMessageNumber ;
...
//       ShowMessage('Alla längder är inte godkända') ;
   End
    ...
    Begin
     ...
     ShowMessage('Alla paket är inte godkända') ;
    End ;
...
//   AddPkgsTo_MTPackagesTable ;
   ...
   if SaveImportedPackages(mtUserProp) then
   Begin
...
begin
 ...
 Begin
  ...
  mtVisKlient.Insert ;
  mtVisKlientClientNo.AsInteger := cds_ImpClientMapClientNo.AsInteger ;//, cds_ImpClientMapWoodXPartyIdentifier.AsString
  mtVisKlient.Post ;

//  UpdateClient (SupplierNo, cds_ImpClientMapWoodXPartyIdentifier.AsString) ;

//   if cds_ImpClientMapClientNo.AsInteger < 1 then
