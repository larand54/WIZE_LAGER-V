...
function GetBiProductName (const BiProductType : Integer) : String ;
...
function GetBiProductName (const BiProductType : Integer) : String ;
Begin
 Case BiProductType of
  cRawChips   : Result:= 'Flis' ;
  cDryChips   : Result:= 'Torrflis' ;
  cRawSawdust : Result:= 'Spån' ;
  cDrySawdust : Result:= 'Torrspån' ;
  cBark       : Result:= 'Bark' ;
 End ;//case
End;
