...
//Load Logical Inv
 ...
 End ; //with
  ...
  grdPackages.LoadFromIniFile(dmsConnector.InifilesMap+'VisMovePkg'+'.'+ThisUser.UserName);
end;
...
begin
 ...
 //Remove entries in Pkgs_Res
  ...
  End ;
  grdPackages.SaveToIniFile(dmsConnector.InifilesMap+'VisMovePkg'+'.'+ThisUser.UserName);
  CloseDataSets;
 End ; 
end;
